...
public interface ProduitMapper {
   ...
   // @Mapping(target = "stockActuel", source = "stockInitial")
    @Mapping(target = "createdAt" ,  ignore = true)
    @Mapping(target = "updatedAt" ,  ignore = true)
    @BeanMapping(nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE)  // ← AJOUTEZ CETTE LIGNE !

    void updateEntityFromDTO(UpdateProduitDTO updateDTO, @MappingTarget Produit produit);
